...
namespace MovieSearch.UnitTests.Application.Movies.Features
{
    public class FindMovieWithTrailersByIdQueryHandlerTests : UnitTestFixture
    {
        ...
        private Task<FindMovieWithTrailersByIdQueryResult> Act(FindMovieWithTrailersByIdQuery query, CancellationToken
            cancellationToken) => _handler.Handle(query, cancellationToken);
        ...
        {
            var query = new FindMovieWithTrailersByIdQuery(1, 20);
            //Act && Assert
        ...
        {
            // Arrange
            var query = new FindMovieWithTrailersByIdQuery(MovieMocks.Data.Id, 20);
            ...
            _videoServiceClient.GetTrailers(Arg.Is(MovieMocks.Data.Title), 20).Returns(movieList);
