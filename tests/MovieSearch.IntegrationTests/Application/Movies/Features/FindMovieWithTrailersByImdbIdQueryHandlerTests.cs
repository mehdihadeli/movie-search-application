...
public class FindMovieWithTrailersByImdbIdQueryHandlerTests : IntegrationTestFixture<Program>
{
    ...
    {
        // Arrange
        var query = new FindMovieWithTrailersByImdbIdQuery(MovieMocks.Data.ImdbId);
