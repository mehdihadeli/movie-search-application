...
{
    public class FindMovieWithTrailersByImdbIdQueryHandlerTests : IntegrationTestFixture<Startup>
    {
        public FindMovieWithTrailersByImdbIdQueryHandlerTests()
        {
        ...
        [Fact]
        public async Task find_movie_with_trailers_by_imdbid_query_should_return_a_valid_movie_with_trailers_dto()
        {
            // Arrange
            var query = new FindMovieWithTrailersByImdbIdQuery(MovieMocks.Data.ImdbId, 20);
