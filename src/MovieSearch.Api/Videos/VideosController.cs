...
public class VideosController : BaseController
{
    ...
    [SwaggerOperation(Summary = "Get the trailers by movie or tv-show name",
    ...
    [SwaggerOperation(Summary = "Get the trailers for a specific movie",
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [SwaggerOperation(Summary = "Get the trailers for a specific tv-show",
