...
public class YoutubeVideoServiceClient : IVideoServiceClient
{
    ...
    public async Task<VideoListResultModel<Core.Generals.Video>> GetTrailers(string movieName,
        int pageSize = 20, string pageToken = "", DateTime? publishedAfter = null, DateTime? publishedBefore = null)
    {
        ...
        var result = new VideoListResultModel<Core.Generals.Video>(searchListResponse.Items
                .Select(x =>
                    new Core.Generals.Video
                    {
                        Iso_639_1 = "en",
                        Iso_3166_1 = "US",
                        Id = x.Id.VideoId,
            ...
            searchListResponse.PageInfo.TotalResults ?? 0, pageToken,
